%%% @doc 
%%% Block Type: Average of all input values
%%% Description:  Set the block output value to the average value of all input values
%%%               
%%% @end 
...
description() -> "Average All Input Values".
