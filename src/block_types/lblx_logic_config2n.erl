...
default_configs(BlockName, Description) -> 
  attrib_utils:merge_attribute_lists(
    ...
    [
      {'0_0_out', {null}}, %| any | null | N/A |
      {'0_1_out', {null}}, %| any | null | N/A |
      {'0_X_out', {null}}, %| any | null | N/A |
      {'1_0_out', {null}}, %| any | null | N/A |
      {'1_1_out', {null}}, %| any | null | N/A |
      {'1_X_out', {null}}, %| any | null | N/A |
      {'X_0_out', {null}}, %| any | null | N/A |
      {'X_1_out', {null}}, %| any | null | N/A |
      {'X_X_out', {null}} %| any | null | N/A |
    ]). 
...
test_sets()->
  ...
  [
    ...
    {InitConfigVals, [{input2, false}, {input1, null}],  [{status, normal}, {value, "Input 1 Null"}]},
    {[{input2, empty}, {input1, false}], [{status, normal}, {value, "Input 2 Null"}]},
    {[{input2, null},  {input1, empty}], [{status, normal}, {value, "All Null"}]},
    ...
    {[{input2, false}, {input1, true}],  [{status, normal}, {value, 1}]},
    {[{input2, true},  {input1, false}], [{status, normal}, {value, 2}]},
