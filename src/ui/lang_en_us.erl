...
[
  ...
  {initial_state,     "initial_state", "This is the initial value when transitioning from a null state"}, 
  ...
  {num_of_inputs,     "num_of_inputs", "Quantity of Input attributes to create"}, 
