...
[
  ...
  {freeze,            "freeze", "Freeze block outputs at last state"}, 
  ...
  {last_exec,         "last_exec", "Time stamp last time block was executed"}, 
  ...
  {num_of_digits,     "num_of_digits", "Number of digits in display"}, 
  {num_of_inputs,     "num_of_inputs", "Number of Input attributes"}, 
  {num_of_nodes,      "num_of_nodes", "Number of nodes to send values"}, 
  ...
  {num_of_values,     "num_of_values", "Number of values to send or receive"}, 
