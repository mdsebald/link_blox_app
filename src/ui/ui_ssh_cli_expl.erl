...
our_routines() ->
    [
     {"exit",    ui_ssh_cli_expl, cli_exit,    "            exit application"},
     {"factors", ui_ssh_cli_expl, cli_factors, "<int>       prime factors of <int>"},
     {"gcd",     ui_ssh_cli_expl, cli_gcd,     "<int> <int> greatest common divisor"},
     {"help",    ui_ssh_cli_expl, cli_help,    "            help text"},
     {"lcm",     ui_ssh_cli_expl, cli_lcm,     "<int> <int> least common multiplier"},
     {"prime",   ui_ssh_cli_expl, cli_prime,   "<int>       check for primality"},
     {"primes",  ui_ssh_cli_expl, cli_primes,  "<int>       print all primes up to <int>"},
     {"rho",     ui_ssh_cli_expl, cli_rho,     "<int>       prime factors using rho's alg."},
     {"user",    ui_ssh_cli_expl, cli_user,    "            print name of user"},
     {"host",    ui_ssh_cli_expl, cli_host,    "            print host addr"},
     {"self",    ui_ssh_cli_expl, cli_self,    "            print my pid"},
     {"nodes",   ui_ssh_cli_expl, cli_nodes,   "            print connected nodes"},
     {"node",    ui_ssh_cli_expl, cli_node,    "            print the local node"},
     {"connect", ui_ssh_cli_expl, cli_connect, "<node>      connect to <node>"},
     {"status",  ui_ssh_cli_expl, cli_status,  "            display block status"}
    ].
